...
ALTER TABLE `users` 
ADD COLUMN `email` VARCHAR(255) DEFAULT NULL UNIQUE AFTER `password`,
ADD COLUMN `google_id` VARCHAR(255) DEFAULT NULL UNIQUE AFTER `email`,
ADD COLUMN `full_name` VARCHAR(255) DEFAULT NULL AFTER `google_id`,
ADD COLUMN `is_pay` TINYINT(1) NOT NULL DEFAULT 0 AFTER `full_name`;
